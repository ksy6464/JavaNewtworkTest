...
public class MyHTTPServer {
	...
	class HttpHandler extends Thread {
		...
		public void run() {
			...
			try {
				...
				/// staus line 까지 header라고하기도 한다
				
				//////////////////////////////////////////////////////////////////
				
				// 응답 헤더정보 보내기
				///out의 writer 호출하면 된다, 소캣을 통해서 브라우저에게 보낸다
				out.write(header);
	...
	private byte[] makeResponseHeader(int contentLength, String mimeType) {
		...
		String header = "HTTP/1.1 200 OK\r\n" ///Status Line
				+ "Server: MyHTTPServer 1.0\r\n" ///여기서부터 아래줄은 Header Line
				+ "Content-Length: "+ contentLength +"\r\n"
				+ "Content-Type: "+mimeType+ "; charset="+ this.ENCODING;
		///"" 안에 들어있는 세미콜론은 구분자이다, 없으면 깨진다, 문법임...
